                    ...
                    <div class="flex items-center gap-1">
                        ...
                        <div id="logo">
                            <router-link :to="{ name: 'home' }">
                                ...
                                />
                                <img
                                    src="/public/images/logo-mobile.png"
                                    class="hidden max-md:block w-20 dark:!hidden"
                                    alt=""
                                />
                                <img
                                    src="/public/images/logo-mobile-light.png"
                ...
                <div class="flex-1 relative">
                    <div class="max-w-[1220px] mx-auto flex items-center">
                        ...
                        >
                            ...
                            >
                                <div
                                    class="flex justify-between px-2 py-2.5 text-sm font-medium"
                                >
                                ...
                                >
                                    ...
                                    >
                                        ...
                                        <div>
                                            <div>Delicious Foods</div>
                                            <div
                                                class="text-xs text-yellow-500 font-medium mt-0.5"
                                            >
                                                Page
                                            </div>
                                        </div>
                        ...
                        >
                            ...
                            >
                                ...
                                >
                                    ...
                                    <!-- slide nav -->
                                    <div
                                        class="justify-center mt-2 -mb-2 hidden dark:flex"
                                    >
                                        <ul
                                ...
                                >
                                    ...
                                    >
                                        ...
                                        <div class="flex-1">
                                            ...
                                            >
                                            <div
                                                class="mt-1 text-xs text-gray-500 dark:text-white"
                                            >
                                                {{ item.description }}
                                            </div>
                                        </div>
                            ...
                            >
                                <!-- heading -->
                                <div
                                    class="flex items-center justify-between gap-2 p-4 pb-2"
                                >
                                ...
                                <div
                                    class="text-sm h-[400px] w-full overflow-y-auto pr-2"
                                >
                                    <!-- contents list -->
                                    <div
                                        class="pl-2 p-1 text-sm font-normal dark:text-white"
                                    >
                                        <a
                                            href="#"
                            ...
                            >
                                <!-- heading -->
                                <div
                                    class="flex items-center justify-between gap-2 p-4 pb-1"
                                >
                                ...
                                <div class="h-80 overflow-y-auto pr-2">
                                    <div
                                        class="p-2 pt-0 pr-1 dark:text-white/80"
                                    >
                                        <a
                                            href="#"
                            ...
                            >
                                <router-link :to="{ name: 'timeline' }">
                                    <div
                                        class="p-4 py-5 flex items-center gap-4"
                                    >
                                        <img
                                            src="/public/images/avatars/avatar-2.jpg"
                                            alt=""
                                ...
                                <nav
                                    class="p-2 text-sm text-black font-normal dark:text-white"
                                >
                            ...
                            <div class="flex items-center gap-2 hidden">
                                ...
                                <div class="w-20 font-semibold text-gray-600">
                                    Hamse
                                </div>
