    ...
    >
        <div class="2xl:max-w-[1220px] max-w-[1065px] mx-auto">
            ...
            <div class="uk-switcher" id="group-tabs">
                <!-- card layout 1 -->
                <div
                    class="grid md:grid-cols-4 sm:grid-cols-3 grid-cols-2 gap-2.5"
                >
                    <div class="card">
                        ...
                        <div class="card-body relative z-10">
                            ...
                            />
                            <a href="timeline-group.html"
                                ><h4 class="card-title">Delicious Foods</h4></a
                            >
                    ...
                    <div class="card">
                        <a href="timeline-group.html">
                            <div class="card-media h-24">
                                <img
                                    src="/public/images/group/group-cover-3.jpg"
                                    alt=""
                                />
                                <div class="card-overly"></div>
                            </div>
                        ...
                        <div class="card-body relative z-10">
                            ...
                            />
                            <a href="timeline-group.html"
                                ><h4 class="card-title">Abstract minimal</h4></a
                            >
                            <div class="card-list-info font-normal mt-1">
                                <a href="#"> Technology </a>
                                <div class="md:block hidden">·</div>
                    ...
                    <div class="card">
                        <a href="timeline-group.html">
                            <div class="card-media h-24">
                                <img
                                    src="/public/images/group/group-cover-2.jpg"
                                    alt=""
                                />
                                <div class="card-overly"></div>
                            </div>
                    ...
                    <div class="card">
                        ...
                        <div class="card-body relative z-10">
                            ...
                            />
                            <a href="timeline-group.html"
                                ><h4 class="card-title">Graphic Design</h4></a
                            >
                            <div class="card-list-info font-normal mt-1">
                                <a href="#"> Design </a>
                                <div class="md:block hidden">·</div>
                ...
                >
                    ...
                    <div class="card">
                        <a href="timeline-group.html">
                            <div class="card-media h-24">
                                <img
                                    src="/public/images/product/product-2.jpg"
                                    alt=""
                                />
                                <div class="card-overly"></div>
                            </div>
                    ...
                    <div class="card">
                        <a href="timeline-group.html">
                            <div class="card-media h-24">
                                <img
                                    src="/public/images/product/product-4.jpg"
                                    alt=""
                                />
                                <div class="card-overly"></div>
                            </div>
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <div class="flex gap-2">
                                ...
                                <button
                                    type="button"
                                    class="button bg-secondery flex-1"
                                >
                                    Edit
                                </button>
                            </div>
            ...
            <div class="sm:my-6 my-3 flex items-center justify-between">
                <div>
                    <h2 class="md:text-lg text-base font-semibold text-black">
                        Categories
                    </h2>
                    ...
                    <ul class="uk-slider-items grid-small">
                        <li class="md:w-1/5 sm:w-1/3 w-1/2">
                            <a href="#">
                                ...
                                >
                                    <div v-html="htmlContent" class="h-36 w-full object-cover overflow-y-auto bg-white"></div>
                                    <div
                                        class="w-full bottom-0 absolute left-0 bg-gradient-to-t from-black/60 pt-10"
                                    >
                                        <div
                                            class="text-white p-5 text-lg leading-3"
                                        >
                                            Shopping
                                        </div>
                                    </div>
                        ...
                        <li class="md:w-1/5 sm:w-1/3 w-1/2">
                            <a href="#">
                                ...
                                >
                                    <img
                                        src="/public/images/category/health.jpg"
                                        alt=""
                        ...
                        <li class="md:w-1/5 sm:w-1/3 w-1/2">
                            <a href="#">
                                ...
                                >
                                    <img
                                        src="/public/images/category/science-and-tech.jpg"
                                        alt=""
                                        class="h-36 w-full object-cover"
                                    />
                                    <div
                        ...
                        <li class="md:w-1/5 sm:w-1/3 w-1/2">
                            <a href="#">
                                ...
                                >
                                    <img
                                        src="/public/images/category/travel.jpg"
                                        alt=""
                                        class="h-36 w-full object-cover"
                                    />
                                    <div
                        ...
                        <li class="md:w-1/5 sm:w-1/3 w-1/2">
                            <a href="#">
                                ...
                                >
                                    <img
                                        src="/public/images/category/business.jpg"
                                        alt=""
                                        class="h-36 w-full object-cover"
                                    />
                                    <div
            ...
            <!-- suggest title -->
            <div
                class="sm:my-6 my-3 flex items-center justify-between lg:mt-10"
            >
                <div>
                    <h2 class="md:text-lg text-base font-semibold text-black">
                        Suggestions
            ...
            <div class="grid md:grid-cols-2 md:gap-2 gap-3">
                <div class="flex md:items-center space-x-4 p-4 rounded-md box">
                    <div
                        class="sm:w-20 w-14 sm:h-20 h-14 flex-shrink-0 rounded-lg relative"
                    >
                        <img
                            src="/public/images/group/group-4.jpg"
                    ...
                    <div class="flex-1">
                        ...
                        <div
                            class="flex space-x-2 items-center text-sm font-normal"
                        >
                            <div>16K Members</div>
                            <div>·</div>
                ...
                <div class="flex md:items-center space-x-4 p-4 rounded-md box">
                    ...
                    >
                        <img
                            src="/public/images/group/group-3.jpg"
                            class="absolute w-full h-full inset-0 rounded-md object-cover shadow-sm"
                            alt=""
                        />
                    </div>
                ...
                <div class="flex md:items-center space-x-4 p-4 rounded-md box">
                    ...
                    >
                        <img
                            src="/public/images/group/group-2.png"
                            class="absolute w-full h-full inset-0 rounded-md object-cover shadow-sm"
                            alt=""
                        />
                    </div>
                ...
                <div class="flex md:items-center space-x-4 p-4 rounded-md box">
                    ...
                    >
                        <img
                            src="/public/images/group/group-1.jpg"
                            class="absolute w-full h-full inset-0 rounded-md object-cover shadow-sm"
                            alt=""
                        />
                    </div>
...
export default {
    ...
    mounted() {
        fetch("/public/html/Buy-and-sell.html")
            .then((res) => res.text())
            .then((html) => {
