            ...
            >
                ...
                <div class="lg:px-10 md:p-5 p-3">
                    <div class="flex flex-col justify-center -mt-20">
                        ...
                        <div
                            class="flex lg:items-center justify-between max-md:flex-col max-md:gap-3"
                        >
                            <div class="flex-1">
                                <h3
                                    class="md:text-2xl text-lg font-bold text-black dark:text-white"
                                >
                                    Monroe Parker
                                </h3>
                                <p
                            ...
                            <div class="flex items-center gap-2 mt-1">
                                ...
                                <button
                                    class="button bg-secondery flex items-center gap-2 py-2 px-3.5 max-lg:flex-1"
                                >
                                    <svg
                                        xmlns="http://www.w3.org/2000/svg"
                                        viewBox="0 0 20 20"
                        ...
                        <div class="box p-5 px-6">
                            ...
                            <div class="side-list">
                                <div class="side-list-item">
                                    ...
                                    <button class="button bg-secondery">
                                        edit
                                    </button>
                                </div>
                                <div class="side-list-item">
        ...
        <div class="hidden lg:p-20 uk- open" id="create-status" uk-modal="">
            ...
            >
                ...
                <div class="p-5 flex justify-between items-center">
                    <div>
                        <button
                            class="inline-flex items-center py-1 px-2.5 gap-1 font-medium text-sm rounded-full bg-slate-50 border-2 border-slate-100 group aria-expanded:bg-slate-100 aria-expanded: dark:text-white dark:bg-slate-700"
                            type="button"
                        >
                            Everyone
                            <ion-icon
