        ...
        <div class="max-w-[1065px] mx-auto">
            ...
            >
                ...
                <div class="relative overflow-hidden lg:h-72 h-36 w-full">
                    <img
                        src="/public/images/group/group-cover-4.jpg"
                        alt=""
                ...
                <div class="lg:px-10 md:p-5 p-3">
                    <div class="flex flex-col justify-center md:-mt-20 -mt-12">
                        <div
                            class="md:w-20 md:h-20 w-12 h-12 overflow-hidden bg-white shadow-md rounded-md z-10 mb-5"
                        >
                            <div class="w-full md:h-5 bg-rose-500 h-3"></div>
                            <div
                                class="grid place-items-center text-black font-semibold md:text-3xl text-lg h-full md:pb-5 pb-3"
                            >
                                14
                            </div>
                        </div>
                        ...
                        <div
                            class="flex lg:items-center justify-between max-lg:flex-col max-lg:gap-2"
                        >
                            <div class="flex-1">
                                <p
                                    class="text-sm font-semibold text-rose-600 mb-1.5"
                                >
                                ...
                                <p
                                    class="font-normal text-gray-500 mt-2 flex gap-2 dark:text-white/80"
                                >
                                    <span> Free </span>
                                    <span> • </span>
                            ...
                            <div>
                                <div
                                    uk-countdown="date: 2024-01-01T08:36:57+00:00"
                                    class="flex gap-3 text-2xl font-semibold text-primary dark:text-white max-lg:justify-center"
                                >
                                    <div
                                        class="bg-primary-soft/40 flex flex-col items-center justify-center rounded-lg w-16 h-16 lg:border-4 border-white md:shadow dark:border-slate-700"
                                    >
                ...
                <div
                    class="flex items-center justify-between px-2 max-md:flex-col"
                >
                    <div
                        class="flex items-center gap-2 text-sm py-2 pr-1 lg:order-1"
                    >
                        <button
                            type="button"
                            class="button bg-secondery flex items-center gap-2 py-2 px-3.5 dark:bg-dark3"
                        >
                            <ion-icon
                                name="star-outline"
                                class="text-xl"
                    ...
                    <nav
                        class="flex gap-0.5 rounded-xl overflow-hidden -mb-px text-gray-500 font-medium text-sm overflow-x-auto dark:text-white/80"
                    >
                        <a
                            href="#"
                        ...
                        <div class="box p-5 px-6 pr-0">
                            ...
                            <div class="grid grid-cols-2 gap-2 text-sm mt-4">
                                <div class="flex gap-3">
                                    <div
                                        class="p-2 inline-flex rounded-full bg-rose-50 self-center"
                                    >
                                        <ion-icon
                                            name="heart"
                            ...
                            <ul
                                class="mt-6 space-y-4 text-gray-600 text-sm dark:text-white/80"
                            >
