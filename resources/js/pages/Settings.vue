    ...
    >
        <div class="max-w-3xl mx-auto">
            <div class="box relative rounded-lg shadow-md">
                <div
                    class="flex md:gap-8 gap-4 items-center md:p-8 p-6 md:pb-4"
                >
                ...
                >
                    ...
                    >
                        <ul
                            class="uk-slider-items w-[calc(100%+10px)] !overflow-hidden"
                    ...
                    <a
                        class="absolute -translate-y-1/2 top-1/2 left-0 flex items-center w-20 h-full p-2 py-1 justify-start bg-gradient-to-r from-white via-white dark:from-slate-800 dark:via-slate-800"
                        href="#"
                    ...
                    <a
                        class="absolute right-0 -translate-y-1/2 top-1/2 flex items-center w-20 h-full p-2 py-1 justify-end bg-gradient-to-l from-white via-white dark:from-slate-800 dark:via-slate-800"
                        href="#"
                        uk-slider-item="next"
                    >
                        <ion-icon
                ...
                >
                    ...
                    <div>
                        <div>
                            ...
                            <div
                                class="flex items-center gap-4 mt-16 lg:pl-[10.5rem]"
                            >
                                <button
                                    type="submit"
                    ...
                    <div>
                        <div>
                            <div
                                class="max-w-lg mx-auto font-normal text-gray-400 text-sm"
                            >
                                <div>
                                    <h4
