                                ...
                                <li class="lg:w-1/4 sm:w-1/3 w-1/2">
                                    <div class="card uk-transition-toggle">
                                        <a href="timeline-page.html">
                                            <div
                                                class="card-media sm:aspect-[2/1.9] h-40"
                                            >
                                                <img
                                        ...
                                        <div
                                            class="card-body p-3 w-full z-10 absolute bg-gradient-to-t bottom-0 from-black/60"
                                        >
                                            <p
                                                class="card-text text-xs text-white/80"
                                            >
                                                Japan
                                            </p>
                                            <a href="timeline-page.html">
                                                <h4
                                                    class="card-title text-sm mt-0.5 !text-white"
                                                >
                                                    Jesse Steeve
                                                </h4>
                                            </a>
                                        ...
                                        <button
                                            type="button"
                                            class="uk-transition-fade absolute top-0 right-0 m-2 z-10 bg-black/20 rounded-full flex p-1"
                                        >
                                            <ion-icon
                                                name="close"
                                                class="text-white"
                    ...
                    <div id="page-tabs" class="uk-switcher mt-10">
                        ...
                        >
                            <div class="card">
                                <a href="timeline-page.html">
                                    <div
                                        class="card-media sm:aspect-[2/1.7] h-40"
                                    >
                                        <img
                                            src="/public/images/avatars/avatar-3.jpg"
                                            alt=""
                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <a href="timeline-page.html">
                                        <h4 class="card-title">Alexa stella</h4>
                                    </a>
                            ...
                            <!-- load more -->
                            <div
                                class="flex justify-center my-6 lg:col-span-3 col-span-2"
                            >
                                <button
                                    type="button"
                        ...
                        >
                            <div class="card flex space-x-5 p-5">
                                <a href="timeline-page.html">
                                    <div
                                        class="card-media w-16 h-16 shrink-0 rounded-full"
                                    >
                                        <img
                                            src="/public/images/avatars/avatar-1.jpg"
                                            alt=""
                        ...
                        >
                            ...
                            <div class="card">
                                <div class="card-media sm:h-24 h-16">
                                    <img
                                        src="/public/images/group/group-cover-5.jpg"
                                        alt=""
                                    />
                                    <div class="card-overly"></div>
                                </div>
            ...
            <div class="2xl:w-[380px] lg:w-[330px] w-full">
                ...
                >
                    ...
                    >
                        ...
                        <button
                            class="bg-secondery w-full text-black py-1.5 font-medium px-3.5 rounded-md text-sm mt-3 dark:text-white"
                        >
                            See all
                        </button>
                    </div>
