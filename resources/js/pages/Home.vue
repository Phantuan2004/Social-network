    ...
    <div>
        ...
        >
            ...
            >
                <div class="max-w-[680px] mx-auto">
                    <!-- Stories section -->
                    <div
                        class="stories-wrapper bg-white rounded-xl shadow-sm p-4 mb-8 dark:bg-dark2 md:max-w-[580px] mx-auto relative"
                    >
                        <div
                        ...
                        >
                            <!-- Create Story -->
                            <div
                                class="story-create min-w-[90px] h-[200px] relative rounded-lg cursor-pointer hover:opacity-95 transition-opacity"
                            ...
                            >
                                ...
                                >
                                    ...
                                    />
                                    <div
                                        class="absolute bottom-0 w-full h-1/4 flex flex-col items-center justify-center bg-white dark:bg-gray-900"
                                    >
                                        <div
                                            class="create-story-button bg-blue-500 rounded-full p-2 -mt-8 border-4 border-white dark:border-gray-900"
                                        >
                                            <ion-icon
                                                name="add"
                            ...
                            <div class="flex gap-2">
                                <a
                                    ...
                                    :key="i"
                                    href="#"
                                    class="block min-w-[90px] group"
                                >
                                    <div
                                        class="story-item relative h-[160px] rounded-lg overflow-hidden"
                                    >
                                        <img
                                            src="/public/images/avatars/avatar-lg-1.jpg"
                                            class="w-full h-full object-cover mr-2"
                                            style="margin-left: 5px"
                                            alt=""
                                        />
                                        <div
                                            class="absolute top-4 left-4 ring-4 ring-blue-500 rounded-full"
                                        >
                                            <img
                                                src="/public/images/avatars/avatar-2.jpg"
                                                class="w-7 h-7 rounded-full border-4 border-white"
                                                alt=""
                                            />
                                        </div>
                                        <div
                                            class="absolute bottom-0 left-0 right-0 px-4 py-3 bg-gradient-to-t from-black/60"
                                        >
                                            <div
                            ...
                            <button
                                type="button"
                                class="absolute -left-4 top-1/2 -translate-y-1/2 bg-white rounded-full p-2 shadow-md z-10 dark:bg-gray-800"
                            ...
                            <button
                                type="button"
                                class="absolute -right-4 top-1/2 -translate-y-1/2 bg-white rounded-full p-2 shadow-md z-10 dark:bg-gray-800"
                    ...
                    <!-- feed story -->
                    <div
                        class="md:max-w-[580px] mx-auto mt-2 flex-1 xl:space-y-6 space-y-3"
                    >
                        <!-- add story -->
                        <div
                        ...
                        >
                            <!-- post heading -->
                            <div
                                class="flex gap-3 sm:p-4 p-2.5 text-sm font-medium"
                            >
                            ...
                            <a href="#preview_modal" uk-toggle>
                                <div
                                    class="relative w-full lg:h-96 h-full sm:px-4"
                                >
                                    <img
                            ...
                            >
                                ...
                                <div
                                    class="flex-1 relative overflow-hidden h-10"
                                >
                                    <textarea
                            ...
                            >
                                ...
                                >
                                    ...
                                    <li class="w-full">
                                        ...
                                        >
                                            <img
                                                src="/public/images/post/img-4.png"
                                                alt=""
                                                class="w-full h-full absolute object-cover insta-0"
                                            />
                                        </a>
                        ...
                        >
                            ...
                            <div class="sm:px-4 p-2.5 pt-0">
                                <p class="font-normal">
                                    ...
                                    with a camera. It can be used to create
                                    images that tell stories, express emotions,
                                    or document reality. it can be fun,
                                    challenging, or rewarding. It can also be a
                            ...
                            >
                                <div class="flex items-start gap-3 relative">
                                    ...
                                    <div class="flex-1">
                                        ...
                                        <p class="mt-0.5">
                                            I love taking photos of nature and
                                            animals. 🌳🐶
                                        </p>
                                    </div>
                                </div>
                        ...
                        >
                            <div class="flex gap-3">
                                <div
                                    class="w-9 h-9 rounded-full bg-slate-300/20"
                                ></div>
                                <div class="flex-1 space-y-3">
                                    <div
                                        class="w-40 h-5 rounded-md bg-slate-300/20"
                                    ></div>
                                    <div
                                        class="w-24 h-4 rounded-md bg-slate-300/20"
                                    ></div>
                                </div>
                                <div
                                    class="w-6 h-6 rounded-full bg-slate-300/20"
                                ></div>
                            </div>

                            <div
                                class="w-full h-52 rounded-lg bg-slate-300/10 my-3"
                            ></div>

                            <div class="flex gap-3">
                                <div
                                    class="w-16 h-5 rounded-md bg-slate-300/20"
                                ></div>

                                <div
                                    class="w-14 h-5 rounded-md bg-slate-300/20"
                                ></div>

                                <div
                                    class="w-6 h-6 rounded-full bg-slate-300/20 ml-auto"
                                ></div>
                                <div
                                    class="w-6 h-6 rounded-full bg-slate-300/20"
                                ></div>
                ...
                <div class="flex-1">
                    <div
                        class="scrollable-sidebar lg:space-y-4 lg:pb-8 max-lg:grid sm:grid-cols-2 max-lg:gap-6 transition-all duration-300 ease-in-out"
                    ...
                    >
                        ...
                        <div class="box p-5 px-6 border1 dark:bg-dark2">
                            ...
                            >
                                <div
                                    class="overflow-hidden uk-slider-container"
                                >
                                    <ul
        ...
        <teleport to="body">
                    ...
                    >
                        <div class="p-5 pb-0">
                            ...
                            <div class="flex gap-3 text-sm font-medium">
                                ...
                                <div class="flex-1">
                                    <h4
                                        class="text-black font-medium dark:text-white"
                                    >
                                        Steeve
                                    </h4>
                                    <div
                                        class="text-gray-500 text-xs dark:text-white/80"
                                    >
                                        2 hours ago
                                    </div>
                                </div>
                            ...
                            <p class="font-normal text-sm leading-6 mt-4">
                                ...
                                camera. it can be fun, challenging. It can also
                                be a hobby, a passion. 📷
                            </p>
            ...
            <div class="hidden lg:p-20 uk- open" id="create-status" uk-modal="">
                ...
                >
                    <div
                        class="text-center py-4 border-b mb-0 dark:border-slate-700"
                    >
