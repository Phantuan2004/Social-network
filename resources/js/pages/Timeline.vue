<template>
    ...
    >
        <div class="max-w-[1065px] mx-auto max-lg:-m-2.5">
            <!-- cover  -->
            <div
                class="bg-white shadow lg:rounded-b-2xl lg:-mt-10 dark:bg-dark2"
            >
                <!-- cover -->
                <div class="relative overflow-hidden w-full lg:h-72 h-48">
                    <img
                        src="/public/images/avatars/profile-cover.jpg"
                        alt=""
                    ...
                    <div class="absolute bottom-0 right-0 m-4 z-20">
                        <div class="flex items-center gap-3">
                            <button
                                class="button bg-white/20 text-white flex items-center gap-2 backdrop-blur-small"
                            >
                                Crop
                            </button>
                            <button
                ...
                <div class="p-3">
                    ...
                    >
                        <div
                            class="relative lg:h-48 lg:w-48 w-28 h-28 mb-4 z-10"
                        >
                            <div
                        ...
                        <p class="mt-2 text-gray-500 dark:text-white/80">
                            ...
                            <a href="#" class="text-blue-500 ml-4 inline-block">
                                Edit
                            </a>
                        </p>
                        ...
                        >
                            ...
                            photography and learning. 📚 I explore genres and
                ...
                <!-- navigations -->
                <div
                    class="flex items-center justify-between mt-3 border-t border-gray-100 px-2 max-lg:flex-col dark:border-slate-700"
                ...
                >
                    <div
                        class="flex items-center gap-2 text-sm py-2 pr-1 max-md:w-full lg:order-2"
                    >
                        <button
                        ...
                        <div>
                            <button
                                type="submit"
                                class="rounded-lg bg-secondery flex px-2.5 py-2 dark:bg-dark3"
                            >
                                <ion-icon
                    ...
                    >
                        ...
                        <a href="#" class="inline-block py-3 leading-8 px-3.5"
                            >Friend
                            <span
                                class="text-xs pl-2 font-normal lg:inline-block hidden"
                                >2,680</span
                            ></a
                        >
                        <a href="#" class="inline-block py-3 leading-8 px-3.5"
                        ...
                        <div>
                            <a
                                href="#"
                                class="inline-flex items-center gap-2 py-3 leading-8 px-3"
                            >
                                More <ion-icon name="chevron-down"></ion-icon>
                            </a>
                            <div
                                class="md:w-[240px] w-screen"
                    ...
                    >
                        ...
                        <div class="sm:px-4 p-2.5 pt-0">
                            <p class="font-normal">
                                ...
                                camera. It can be used to create images that
                                tell stories, express emotions, or document
                                reality. it can be fun, challenging, or
                                rewarding. It can also be a hobby, a profession,
                                or a passion. 📷
                            </p>
                        </div>
                ...
                <div class="lg:w-[400px]">
                    ...
                    >
                        <div class="box p-5 px-6">
                            ...
                            <ul
                                class="text-gray-700 space-y-4 mt-4 text-sm dark:text-white/80"
                            >
                            ...
                            <!-- Hobbies -->
                            <div
                                class="flex flex-wrap gap-1 text-sm mt-4 font-semibold capitalize"
                            >
                                <div
                        ...
                        <div class="box p-5 px-6">
                            ...
                            >
                                <h3 class="font-bold text-lg">
                                    Friends
                                    <span
                                        class="block text-sm text-gray-500 mt-0. font-normal dark:text-white"
                                    >
                                        3489 Friends
                                    </span>
                                </h3>
                            ...
                            <div
                                class="grid grid-cols-3 gap-2 gap-y-5 text-center text-sm mt-4 mb-2"
                            >
                                <div>
                                    <div
                                        class="relative w-full aspect-square rounded-lg overflow-hidden"
                                    >
                                        <img
                                            src="/public/images/avatars/avatar-7.jpg"
                                            alt=""
                        ...
                        <!-- Groups You Manage  -->
                        <div
                            class="bg-white rounded-xl shadow p-5 px-6 border1 dark:bg-dark2"
                        >
                            <div
                            ...
                            <div class="side-list">
                                <div class="side-list-item">
                                    ...
                                    <button
                                        class="button bg-primary-soft dark:text-white"
                                    >
                                        Like
                                    </button>
                                </div>
                                ...
                                <div class="side-list-item">
                                    <a href="timeline-group.html">
                                        <img
                                            src="/public/images/avatars/avatar-1.jpg"
                                            alt=""
                                            class="side-list-image rounded-full"
                                        />
                                    </a>
                            ...
                            <button
                                class="bg-secondery w-full text-black py-1.5 font-medium px-3.5 rounded-md text-sm mt-2 dark:text-white"
                            >
                                See all
                            </button>
                        </div>
