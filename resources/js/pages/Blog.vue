    ...
    >
        ...
        >
            <div class="flex-1">
                                ...
                                <div class="card">
                                    <a href="blog-read.html">
                                        <div class="card-media h-32">
                                            <img
                                                src="/public/images/blog/img-1.jpg"
                                                alt=""
                                            />
                                    ...
                                    <div class="card-body">
                                        <a href="blog-read.html">
                                            ...
                                            >
                                                Top amazing web demos and
                                                experiments in 2024 should know
                                                about
                                            </h4>
                                        </a>
                                        <p class="card-text text-xs mt-1.5">
                                            <a href="#"> Jesse Steeve </a>
                                        </p>
                                        <div
                                            class="card-list-info mt-1 text-xs"
                                        >
                                            <div>10 Jun 2022</div>
                                    ...
                                    <div class="card-body">
                                        <a href="blog-read.html">
                                            <h4
                                                class="card-title text-sm line-clamp-2"
                                            >
                                                Awesome web dev tools and
                                                resources for 2024 in 30 minutes
                                            </h4>
                                        </a>
                                        <p class="card-text text-xs mt-1.5">
                            ...
                            <li class="sm:w-1/3 w-1/2">
                                <div class="card">
                                    <a href="blog-read.html">
                                        <div class="card-media h-32">
                                            <img
                                                src="/public/images/blog/img-3.png"
                                                alt=""
                                            />
                                            <div class="card-overly"></div>
                                        </div>
                                    ...
                                    <div class="card-body">
                                        <a href="blog-read.html">
                                            <h4
                                                class="card-title text-sm line-clamp-2"
                                            >
                                                Interesting JavaScript and CSS
                                                libraries should Know About
                                            </h4>
                                        </a>
                                        <p class="card-text text-xs mt-1.5">
                            ...
                            <li class="sm:w-1/3 w-1/2">
                                <div class="card">
                                    <a href="blog-read.html">
                                        <div class="card-media h-32">
                                            <img
                                                src="/public/images/blog/img-4.png"
                                                alt=""
                                            />
                                            <div class="card-overly"></div>
                                        </div>
                ...
                <div class="card mt-8">
                    <div class="card-media md:h-80 h-52">
                        <img
                            src="/public/images/group/group-cover-1.jpg"
                            alt=""
                        />
                        <div class="card-overly"></div>
                    </div>
                    <div
                        class="card-body p-5 w-full z-10 absolute bg-gradient-to-t bottom-0 from-black/60"
                    >
                        <p class="card-text text-white/80">
                            <a href="#"> Denise Marie </a>
                        </p>
                        <h4 class="card-title text-xl mt-1.5 !text-white">
                            Exploring an Abandoned Water Park in China
                        </h4>

                        <div
                            class="card-list-info font-medium mt-1 text-xs mt-1.5 gap-2.5 text-white"
                        >
                ...
                <!-- recomended writters-->
                <div
                    class="bg-secondery p-6 rounded-md mt-8 shadow dark:bg-dark2"
                >
                    <div
                ...
                <!-- title -->
                <div
                    class="flex items-center justify-between text-black dark:text-white py-3 mt-8"
                >
                        ...
                        <div class="card-list-body">
                            <a href="blog-read.html">
                                <h3 class="card-list-title">
                                    Top amazing web demos and experiments in
                                    2024 should know about
                                </h3>
                            </a>
            ...
            <div class="2xl:w-[380px] lg:w-[330px] w-full">
                ...
                >
                    <div
                        class="relative uk-visible-toggle"
                        tabindex="-1"
                    ...
                    >
                        <ul class="uk-slideshow-items">
                            <li class="w-full overflow-hidden rounded-xl">
                                ...
                                />
                                <div
                                    class="absolute bottom-0 w-full uk-transition-slide-bottom-small"
                                >
                                    <div
                                        class="bg-black/10 p-4 m-2 rounded-md backdrop-blur-lg mb-8"
                                    >
                                        <a href="timeline.html"
                                            ><h4
                                        ...
                                        >
                                        <div
                                            class="text-xs text-white/80 mt-2 flex items-center gap-2"
                                        >
                                            <div>10 Jun 2022</div>
                                            <div class="md:block hidden">·</div>
                                            <div>156.9K views</div>
                        ...
                        <div class="flex justify-center">
                            <ul
                                class="inline-flex flex-wrap justify-center absolute bottom-3 gap-1.5 uk-dotnav uk-slideshow-nav"
                            ></ul>
                        </div>
                        ...
                        <a class="nav-next" href="#" uk-slideshow-item="next">
                            <ion-icon
                                name="chevron-forward"
                                class="text-2xl"
                            ></ion-icon
                    ...
                    <div class="box p-5 px-6">
                        ...
                        <div class="mt-4 space-y-4">
                            <div>
                                ...
                                >
                                <div
                                    class="text-xs text-gray-400 mt-2 flex items-center gap-2"
                                >
                                    <div>10 Jun 2022</div>
                                    <div class="md:block hidden">·</div>
                                    <div>156.9K views</div>
                            ...
                            <div>
                                <a href="blog-read.html"
                                    ><h4
                                        class="text-sm font-normal text-black dark:text-white duration-200 hover:opacity-80"
                                    >
                                        Top amazing web demos and experiments
                                        should know about
                                    </h4></a
                                >
                                <div
