<template>
    ...
    >
        <div
            class="lg:flex 2xl:gap-8 gap-6 2xl:max-w-[1220px] max-w-[1065px] mx-auto"
            id="js-oversized"
        >
            <div class="flex-1">
                <!--  post image-->
                ...
                >
                    ...
                    <div
                        class="videoFrame"
                        uk-sticky="cls-active: sticked uk-animation-scale-up; media: 992; top:600"
                    >
                        <iframe
                            src="https://www.youtube.com/embed/0fYi8SGA20k"
                            class="w-full rounded-t-md aspect-video"
                        ...
                        <button
                            ...
                            id="closebtn"
                            class="hidden"
                            uk-toggle="target:.videoFrame ; cls: hide"
                        >
                    ...
                    <p class="font-normal text-sm leading-6 px-6">
                        Photography is the art of capturing light with a camera.
                        It can be used to create images that tell stories,
                        express emotions, or document reality. it can be fun,
                        challenging, or rewarding. It can also be a hobby, a
                    ...
                    <!-- comments -->
                    <div
                        class="sm:p-6 p-2.5 border-t border-gray-100 font-normal space-y-3 relative dark:border-slate-700/40"
                    >
                        ...
                        <button
                            type="button"
                            class="flex items-center gap-1.5 text-blue-500 mt-2"
                        >
                            <ion-icon
                ...
                >
                    ...
                    <div class="box p-5 pr-2">
                        ...
                        <div class="mt-3 space-y-4">
                            <!-- single video -->
                            <div
                                class="relative flex lg:flex-row flex-col gap-2.5"
                            >
                                <!-- video thumbal -->
                                <div
                                    class="relative lg:w-[130px] lg:h-[80px] aspect-[3/1.5] overflow-hidden rounded-lg shrink-0"
                                >
                                    <img
                                        class="object-cover w-full h-full"
                                        src="/public/images/video/img-2.png"
                                        alt=""
                                    />
                                    <!-- iconplay -->
                                    <img
                                    ...
                                    <!-- timer -->
                                    <div
                                        class="absolute bottom-1 right-1 bg-black/70 font-normal rounded px-0.5 py-0.5 text-xs text-white"
                                    >
                                        10:32
                                    </div>
                                </div>
                                ...
                                <div class="flex-1">
                                    <a href="#">
                                        <h3
                                            class="text-sm font-semibold line-clamp-2 mb-1.5"
                                        >
                                            Great drone jet testing range flat
                                            model show with advance
                                        </h3></a
                                    >
                                    <div class="text-xs">
                                        <a
                                        ...
                                        >
                                            ...
                                            <ion-icon
                                                ...
                                                class="dark:text-white md hydrated"
                                                role="img"
                            ...
                            >
                                ...
                                >
                                    <img
                                        class="object-cover w-full h-full"
                                        src="/public/images/video/img-3.png"
                                        alt=""
                                    />
                                    <!-- iconplay -->
                                    <img
                                ...
                                <div class="flex-1">
                                    <a href="#">
                                        <h3
                                            class="text-sm font-semibold line-clamp-2 mb-1.5"
                                        >
                                            Exploring latest an abandoned water
                                            park in china city
                                        </h3></a
                                    >
                                    <div class="text-xs">
                            ...
                            >
                                ...
                                >
                                    <img
                                        class="object-cover w-full h-full"
                                        src="/public/images/video/img-4.png"
                                        alt=""
                                    />
                                    <!-- iconplay -->
                                    <img
                                ...
                                <div class="flex-1">
                                    <a href="#">
                                        <h3
                                            class="text-sm font-semibold line-clamp-2 mb-1.5"
                                        >
                                            cheese cake eggless without oven
                                            hida mari cooking
                                        </h3></a
                                    >
                                    <div class="text-xs">
                            ...
                            >
                                ...
                                >
                                    <img
                                        class="object-cover w-full h-full"
                                        src="/public/images/video/img-5.png"
                                        alt=""
                                    />
                                    <!-- iconplay -->
                                    <img
                                ...
                                <div class="flex-1">
                                    <a href="#">
                                        <h3
                                            class="text-sm font-semibold line-clamp-2 mb-1.5"
                                        >
                                            Amazing little girl has very talent
                                            voice vocal coach
                                        </h3></a
                                    >
                                    <div class="text-xs">
                            ...
                            >
                                ...
                                >
                                    <img
                                        class="object-cover w-full h-full"
                                        src="/public/images/video/img-1.png"
                                        alt=""
                                    />
                                    <!-- iconplay -->
                                    <img
                                ...
                                <div class="flex-1">
                                    <a href="#">
                                        <h3
                                            class="text-sm font-semibold line-clamp-2 mb-1.5"
                                        >
                                            Amazing house construction from
                                            foundation to last detail
                                        </h3></a
                                    >
                                    <div class="text-xs">
                                        <a
    ...
    <teleport to="body">
        <div
            class="hidden lg:p-10 max-lg:!items-start lg:overflow-hidden uk-open"
            id="preview_modal"
            uk-modal=""
        >
            <div
                class="uk-modal-dialog tt relative mx-auto overflow-hidden shadow-xl rounded-lg lg:flex items-center w-full lg:h-[85vh]"
            >
                <!-- video player -->
                <div
                    class="lg:h-full lg:w-[calc(100vw-400px)] w-full h-96 flex justify-center items-center relative bg-black/90 backdrop-blur"
                >
                    <div
                        class="w-full"
                        uk-sticky="cls-active: sticked uk-animation-scale-up; media: 992; top:600"
                ...
                >
                    <div class="p-5 pb-0">
                        ...
                        <p class="font-normal text-sm leading-6 mt-4">
                            ...
                            camera. it can be fun, challenging. It can also be a
                            hobby, a passion. 📷
                        </p>
                        ...
                        <div class="shadow relative -mx-5 px-5 py-3 mt-3">
                            ...
                            >
                                ...
                                <div class="flex items-center gap-3">
                                    <button
                                        type="button"
                                        class="button-icon bg-slate-100 dark:bg-slate-700"
                                    >
                                        <ion-icon
                                            class="text-lg"
                                            name="chatbubble-ellipses"
                    ...
                    <div
                        class="bg-white p-3 text-sm font-medium flex items-center gap-2 dark:bg-dark2"
                    >
                        <img
                            src="/public/images/avatars/avatar-2.jpg"
                            alt=""
