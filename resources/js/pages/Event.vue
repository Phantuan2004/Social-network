<template>
    ...
    >
        <div class="2xl:max-w-[1220px] max-w-[1065px] mx-auto">
                            ...
                            <div class="card">
                                <a href="timeline-event.html">
                                    <div class="card-media h-32">
                                        <img
                                            src="/public/images/events/img-3.jpg"
                                            alt=""
                                        />
                                ...
                                <div class="card-body">
                                    ...
                                    <a href="#">
                                        <p class="card-text text-black mt-2">
                                            Dubai
                                        </p>
                                    </a>
                        ...
                        <li class="lg:w-1/4 sm:w-1/3 w-1/2">
                            <div class="card">
                                <a href="timeline-event.html">
                                    <div class="card-media h-32">
                                        <img
                                            src="/public/images/events/img-2.jpg"
                                            alt=""
                                        />
                                        <div class="card-overly"></div>
                                    </div>
                                ...
                                <div class="card-body">
                                    <p
                                        class="text-xs font-semibold text-teal-600 mb-1"
                                    >
                                        Opening
                                    </p>
                                    <a href="timeline-event.html"
                        ...
                        <li class="lg:w-1/4 sm:w-1/3 w-1/2">
                            <div class="card">
                                <a href="timeline-event.html">
                                    <div class="card-media h-32">
                                        <img
                                            src="/public/images/events/img-1.jpg"
                                            alt=""
                                        />
                                        <div class="card-overly"></div>
                                    </div>
                        ...
                        <li class="lg:w-1/4 sm:w-1/3 w-1/2">
                            <div class="card">
                                <a href="timeline-event.html">
                                    <div class="card-media h-32">
                                        <img
                                            src="/public/images/events/img-4.jpg"
                                            alt=""
                                        />
                                        <div class="card-overly"></div>
                                    </div>
            ...
            <div
                class="sm:my-6 my-3 flex items-center justify-between md:mt-10"
            >
                <div>
                    ...
                    <ul class="uk-slider-items grid-small">
                        <li class="md:w-1/5 sm:w-1/3 w-1/2">
                            <a href="#">
                                ...
                                >
                                    <img
                                        src="/public/images/events/listing-1.png"
                                        alt=""
                                    ...
                                    >
                                        <div class="text-white p-5">
                                            ...
                                            <div
                                                class="text-lg leading-3 mt-1.5"
                                            >
                                                Hotels
                                            </div>
                                        </div>
                        ...
                        <li class="md:w-1/5 sm:w-1/3 w-1/2">
                            <a href="#">
                                ...
                                >
                                    <img
                                        src="/public/images/events/listing-2.png"
                                        alt=""
                                        class="h-36 w-full object-cover"
                                    />
                                    <div
                        ...
                        <li class="md:w-1/5 sm:w-1/3 w-1/2">
                            <a href="#">
                                ...
                                >
                                    <img
                                        src="/public/images/events/listing-3.png"
                                        alt=""
                                        class="h-36 w-full object-cover"
                                    />
                                    <div
                        ...
                        <li class="md:w-1/5 sm:w-1/3 w-1/2">
                            <a href="#">
                                ...
                                >
                                    <img
                                        src="/public/images/events/listing-4.png"
                                        alt=""
                                        class="h-36 w-full object-cover"
                                    />
                                    <div
                        ...
                        <li class="md:w-1/5 sm:w-1/3 w-1/2">
                            <a href="#">
                                ...
                                >
                                    <img
                                        src="/public/images/events/listing-5.jpg"
                                        alt=""
                                        class="h-36 w-full object-cover"
                                    />
                                    <div
            ...
            >
                <div class="card">
                    <a href="timeline-event.html">
                        <div class="card-media h-32">
                            <img src="/public/images/events/img-1.jpg" alt="" />
                            <div class="card-overly"></div>
                        </div>
                    </a>
                    <div class="card-body">
                        <p
                            class="text-xs font-medium text-black text-red-600 mb-1"
                        >
                            WED JUL 10,2024 AT 10PM
                        </p>
                        <a href="timeline-event.html"
                ...
                <div class="card">
                    <a href="timeline-event.html">
                        <div class="card-media h-32">
                            <img src="/public/images/events/img-2.jpg" alt="" />
                            <div class="card-overly"></div>
                        </div>
                    </a>
                    <div class="card-body">
                        ...
                        <a href="#">
                            <p class="card-text text-black mt-2">Turkey</p></a
                        >
                        <div class="card-list-info text-xs mt-1">
                            <div>20 Intersted</div>
                            <div class="md:block hidden">·</div>
                ...
                <div class="card">
                    <a href="timeline-event.html">
                        <div class="card-media h-32">
                            <img src="/public/images/events/img-3.jpg" alt="" />
                            <div class="card-overly"></div>
                        </div>
                    </a>
                    <div class="card-body">
                ...
                <div class="card">
                    <a href="timeline-event.html">
                        <div class="card-media h-32">
                            <img src="/public/images/events/img-4.jpg" alt="" />
                            <div class="card-overly"></div>
                        </div>
                    </a>
                    <div class="card-body">
                        ...
                        <a href="#">
                            <p class="card-text text-black mt-2">London</p></a
                        >
                        <div class="card-list-info text-xs mt-1">
                            <div>20 Intersted</div>
                            <div class="md:block hidden">·</div>
