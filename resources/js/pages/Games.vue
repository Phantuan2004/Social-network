                    ...
                    <div class="max-w-[680px] w-full mx-auto content-area">
                            ...
                            <div class="grid md:grid-cols-4 grid-cols-3 md:gap-3 gap-2" uk-scrollspy="target: > div; cls: uk-animation-scale-up; delay: 20 ;repeat: true">
                                    ...
                                    <div class="card">
                                        <a href="#">
                                            <div class="card-media sm:aspect-[2/1.8] h-36">
                                                <img src="/public/images/games/img-1.jpg" alt="">
                                ...
                                <div>
                                    <div class="card">
                                        <a href="#">
                                            <div class="card-media sm:aspect-[2/1.8] h-36">
                                                <img src="/public/images/games/img-2.jpg" alt="">
                                                <div class="card-overly"></div>
                                            </div>
                                        </a>
                                        <div class="card-body">
                                ...
                                <div>
                                    <div class="card">
                                        <a href="#">
                                            <div class="card-media sm:aspect-[2/1.8] h-36">
                                                <img src="/public/images/games/img-4.jpg" alt="">
                                                <div class="card-overly"></div>
                                            </div>
                                        </a>
                                        <div class="card-body">
                                ...
                                <div>
                                    <div class="card">
                                        <a href="#">
                                            <div class="card-media sm:aspect-[2/1.8] h-36">
                                                <img src="/public/images/games/img-5.jpg" alt="">
                                                <div class="card-overly"></div>
                                            </div>
                                        </a>
                                        <div class="card-body">
                                ...
                                <div>
                                    <div class="card">
                                        <a href="#">
                                            <div class="card-media sm:aspect-[2/1.8] h-36">
                                                <img src="/public/images/games/img-3.jpg" alt="">
                                                <div class="card-overly"></div>
                                            </div>
                                        </a>
                                        <div class="card-body">
                                ...
                                <div>
                                    <div class="card">
                                        <a href="#">
                                            <div class="card-media sm:aspect-[2/1.8] h-36">
                                                <img src="/public/images/games/img-6.jpg" alt="">
                                                <div class="card-overly"></div>
                                            </div>
                                        </a>
                                        <div class="card-body">
                        ...
                        <div class="box p-5 mt-6">
                            ...
                            <div class="card-list">
                                <a href="#">
                                    <div class="card-list-media md:h-full">
                                        <img src="/public/images/games/img-lg-1.jpg" alt="" class="shadow">
                            ...
                            <div class="card-list">
                                <a href="#">
                                    <div class="card-list-media md:h-full">
                                        <img src="/public/images/games/img-lg-2.jpg" alt="" class="shadow">
                                        <img src="/public/images/icon-play.svg" class="!w-12 !h-12 absolute !top-1/2 !left-1/2 -translate-x-1/2 -translate-y-1/2" alt="">
                                    </div>
                                </a>
                                <div class="card-list-body">
                            ...
                            <div class="card-list">
                                <a href="#">
                                    <div class="card-list-media md:h-full">
                                        <img src="/public/images/games/img-lg-3.jpg" alt="" class="shadow">
                                        <img src="/public/images/icon-play.svg" class="!w-12 !h-12 absolute !top-1/2 !left-1/2 -translate-x-1/2 -translate-y-1/2" alt="">
                                    </div>
                                </a>
                                <div class="card-list-body">
                        ...
                        <div class="box p-5 px-6">
                            ...
                            <div class="side-list">
                                ...
                                <div class="side-list-item">
                                    <a href="#">
                                        <img src="/public/images/games/img-3.jpg" alt="" class="side-list-image rounded-md">
                                    </a>
                                    <div class="flex-1">
                                ...
                                <div class="side-list-item">
                                    <a href="#">
                                        <img src="/public/images/games/img-4.jpg" alt="" class="side-list-image rounded-md">
                                    </a>
                                    <div class="flex-1">
                                ...
                                <div class="side-list-item">
                                    <a href="#">
                                        <img src="/public/images/games/img-6.jpg" alt="" class="side-list-image rounded-md">
                                    </a>
                                    <div class="flex-1">
                                ...
                                <div class="side-list-item">
                                    <a href="#">
                                        <img src="/public/images/games/img-1.jpg" alt="" class="side-list-image rounded-md">
                                    </a>
                                    <div class="flex-1">
                            ...
                            <div class="space-y-4 capitalize text-xs font-normal mt-5 mb-2 text-gray-500 dark:text-white/80">
                                ...
                                <div class="flex items-center gap-3">
                                    <a href="timeline.html">
                                        <img src="/public/images/avatars/avatar-7.jpg" alt="" class="bg-gray-200 rounded-full w-10 h-10">
                                    </a>
                                    <div class="flex-1">
                                ...
                                <div class="flex items-center gap-3">
                                    <a href="timeline.html">
                                        <img src="/public/images/avatars/avatar-5.jpg" alt="" class="bg-gray-200 rounded-full w-10 h-10">
                                    </a>
                                    <div class="flex-1">
                                ...
                                <div class="flex items-center gap-3">
                                    <a href="timeline.html">
                                        <img src="/public/images/avatars/avatar-2.jpg" alt="" class="bg-gray-200 rounded-full w-10 h-10">
                                    </a>
                                    <div class="flex-1">
                                ...
                                <div class="flex items-center gap-3">
                                    <a href="timeline.html">
                                        <img src="/public/images/avatars/avatar-3.jpg" alt="" class="bg-gray-200 rounded-full w-10 h-10">
                                    </a>
                                    <div class="flex-1">
                                ...
                                <div class="flex items-center gap-3">
                                    <a href="timeline.html">
                                        <img src="/public/images/avatars/avatar-4.jpg" alt="" class="bg-gray-200 rounded-full w-10 h-10">
                                    </a>
                                    <div class="flex-1">
