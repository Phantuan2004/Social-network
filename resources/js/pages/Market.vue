<template>
    ...
    >
        <div
            class="lg:flex 2xl:gap-12 gap-10 2xl:max-w-[1220px] max-w-[1065px] mx-auto"
            id="js-oversized"
        >
            <div class="flex-1">
                <div class="lg:max-w-[680px] w-full">
                    <div class="page-heading">
                        ...
                        <button type="button" class="absolute right-3 bottom-5">
                            <div
                                class="w-7 h-7 bg-blue-600 rounded-full shadow grid place-items-center"
                            >
                                <ion-icon
                                    name="add"
                    ...
                    >
                                ...
                                >
                                    <div class="card">
                                        <a href="product-view-1.html">
                                            <div
                                                class="card-media sm:aspect-[2/1.7] h-36"
                                            >
                                                <img
                                                    src="/public/images/product/product-1.jpg"
                                                    alt=""
                                                />
                                        ...
                                        <div class="card-body relative">
                                            <a href="#"
                                                ><span
                                                    class="text-teal-600 font-semibold text-xs"
                                                >
                                                    Herbel</span
                                                ></a
                                            >
                                            <a href="product-view-1.html"
                                                ><p
                                                    class="card-text block text-black mt-0.5"
                                                >
                                                    Chill Lotion
                                                </p></a
                                            >
                                ...
                                <li class="pr-3 md:w-1/3 w-1/2">
                                    <div class="card">
                                        <a href="product-view-1.html">
                                            ...
                                            >
                                                <img
                                                    src="/public/images/product/product-3.jpg"
                                                    alt=""
                                                />
                                                <div class="card-overly"></div>
                                            </div>
                                ...
                                <li class="pr-3 md:w-1/3 w-1/2">
                                    <div class="card">
                                        <a href="product-view-1.html">
                                            ...
                                            >
                                                <img
                                                    src="/public/images/product/product-6.jpg"
                                                    alt=""
                                                />
                                                <div class="card-overly"></div>
                                            </div>
                                ...
                                <li class="pr-3 md:w-1/3 w-1/2">
                                    <div class="card">
                                        <a href="product-view-1.html">
                                            ...
                                            >
                                                <img
                                                    src="/public/images/product/product-5.jpg"
                                                    alt=""
                                                />
                                                <div class="card-overly"></div>
                                            </div>
                        ...
                        <div class="flex justify-center">
                            <ul
                                class="inline-flex flex-wrap justify-center my-5 gap-2 uk-dotnav uk-slider-nav"
                            ></ul>
                        </div>
                    </div>
                    ...
                    >
                        <div
                            class="sm:my-6 my-3 flex items-center justify-between border-t pt-3 dark:border-slate-800"
                        >
                            <div>
                                ...
                                <p
                                    class="font-normal text-sm text-gray-500 leading-6 hidden"
                                >
                                    Find a group by browsing top categories.
                                </p>
                            </div>
                            <div
                                class="flex items-center gap-2 [&:has(a.uk-invisible)][&*>a]:bg-red-600"
                            >
                                <a
                                    href="#"
                                ...
                                >
                                    <div class="card flex gap-1">
                                        <a href="product-view-2.html">
                                            <div
                                                class="card-media w-32 max-h-full h-full shrink-0"
                                            >
                                                <img
                                                    src="/public/images/product/product-9.jpg"
                                                    alt=""
                                                />
                                                <div class="card-overly"></div>
                                            </div>
                                        ...
                                        <div class="card-body flex-1 py-4">
                                            ...
                                            >
                                            <div
                                                class="text-xl flex items-center justify-between mt-2"
                                            >
                                            ...
                                            <div class="flex gap-2">
                                                ...
                                                <button
                                                    type="button"
                                                    class="button bg-secondery !w-auto"
                                                >
                                                    <svg
                    ...
                    <!-- categories -->
                    <div
                        class="sm:mt-6 mt-3 flex items-center justify-between border-t pt-3 dark:border-slate-800"
                    >
                        <div>
                            <h2 class="text-xl font-semibold text-black">
                                Categories
                            ...
                            <p
                                class="font-normal text-sm text-gray-500 leading-6"
                            >
                                Find a group by browsing top categories.
                            </p>
                        </div>
                    ...
                    >
                        <div class="py-5 uk-slider-container">
                            <ul
                                class="uk-slider-items w-[calc(100%+12px)]"
                                uk-scrollspy="target: > li; cls: uk-animation-scale-up; delay: 20;repeat:true"
                            >
                                <li
                                    class="pr-3 md:w-1/3 w-auto"
                                    uk-scrollspy-class="uk-animation-fade"
                                >
                                    <div
                                        class="p-4 flex gap-3 justify-between bg-sky-600 rounded-md"
                                    >
                                        <div>
                                            <h4
                                                class="font-medium !text-white whitespace-nowrap"
                                            >
                                                All Categories
                                            </h4>
                                            <p
                                                class="font-medium !text-white/80 text-sm mt-1 whitespace-nowrap"
                                            >
                                                14 product
                                            </p>
                                        </div>
                                ...
                                >
                                    <div
                                        class="p-4 flex gap-3 item-center justify-between bg-rose-500 rounded-md"
                                    >
                                        <div>
                                            ...
                                            <p
                                                class="font-medium !text-white/80 text-sm mt-1"
                                            >
                                                23 product
                                            </p>
                                        </div>
                                ...
                                >
                                    <div
                                        class="p-4 flex gap-3 item-center justify-between bg-teal-600 rounded-md"
                                    >
                                        <div>
                                            <h4 class="font-medium !text-white">
                                                Life style
                                ...
                                >
                                    <div
                                        class="p-4 flex gap-3 item-center justify-between bg-sky-600 rounded-md"
                                    >
                                        <div>
                                            <h4 class="font-medium !text-white">
                                                Electronic
                                ...
                                >
                                    <div
                                        class="p-4 flex gap-3 item-center justify-between bg-pink-600 rounded-md"
                                    >
                                        <div>
                                            <h4 class="font-medium !text-white">
                                                Building
                    ...
                    >
                        <div class="card uk-transition-toggle">
                            <a href="product-view-1.html">
                                <div class="card-media sm:aspect-[2/1.7] h-36">
                                    <img
                                        src="/public/images/product/product-10.jpg"
                                        alt=""
                                    />
                                    <div class="card-overly"></div>
                                </div>
                            ...
                            <div class="card-body flex justify-between">
                                <div class="flex-1">
                                    <p
                                        class="card-text text-black font-medium line-clamp-1"
                                    >
                                        Herbel
                                    </p>
                        ...
                        <div class="card uk-transition-toggle">
                            <a href="product-view-1.html">
                                <div class="card-media sm:aspect-[2/1.7] h-36">
                                    <img
                                        src="/public/images/product/product-8.jpg"
                                        alt=""
                                    />
                                    <div class="card-overly"></div>
                                </div>
            ...
            <div class="2xl:w-[380px] lg:w-[330px] w-full">
                ...
                >
                        ...
                        <div class="side-list">
                            <div class="side-list-item">
                                <a href="timeline.html">
                                    <img
                                        src="/public/images/avatars/avatar-2.jpg"
                                        alt=""
                            ...
                            <div class="side-list-item">
                                <a href="timeline.html">
                                    <img
                                        src="/public/images/avatars/avatar-5.jpg"
                                        alt=""
                                        class="side-list-image rounded-full"
                                    />
                                </a>
                            ...
                            <div class="side-list-item">
                                <a href="timeline.html">
                                    <img
                                        src="/public/images/avatars/avatar-6.jpg"
                                        alt=""
                                        class="side-list-image rounded-full"
                                    />
                                </a>
                            ...
                            <button
                                class="bg-secondery button w-full mt-2 hidden"
                            >
                                See all
                            </button>
                        </div>
                    ...
                    <div class="box p-5 px-6 border1 dark:bg-dark2">
                        <div
                            class="flex justify-between text-black dark:text-white"
                        >
                        ...
                        >
                            <div class="overflow-hidden uk-slider-container">
                                <ul
                                    class="-ml-2 uk-slider-items w-[calc(100%+0.5rem)]"
                                >
                                    <li class="w-1/2 pr-2">
                                        <a href="#">
                                            <div
                    ...
                    <div class="box p-5 px-6 border1 dark:bg-dark2">
                        ...
                        <div class="grid grid-cols-6 gap-3 mt-4">
                            ...
                            <a href="timeline.html">
                                <div class="w-10 h-10 relative">
                                    <img
                                        src="/public/images/avatars/avatar-7.jpg"
                                        alt=""
                                        class="w-full h-full absolute inset-0 rounded-full"
                                    />
                                    <div
                                    ...
                                    <li class="w-1/2 pr-2">
                                        <a href="timeline.html">
                                            ...
                                            >
                                                <a href="timeline.html">
                                                    <div
                                                        class="relative w-16 h-16 mx-auto mt-2"
                                                    >
                                                        <img
                                                            src="/public/images/avatars/avatar-5.jpg"
                                                            alt=""
    ...
    <teleport to="body">
        ...
        <button
            type="button"
            class="fixed bottom-0 right-0 m-10"
            uk-toggle="target: #create_product"
            uk-tooltip="title:Add Product ; offset:10"
        >
            <div
                class="flex items-center justify-center w-12 h-12 bg-gradient-to-br from-sky-400 to-sky-600 rounded-full"
            >
                <ion-icon
                    name="add-outline"
        ...
        >
            <div
                class="uk-modal-dialog tt relative mx-auto bg-white shadow-xl rounded-lg max-lg:w-full dark:bg-dark2"
            >
                <!-- header card -->
                <div
                    class="border-b px-3 py-3 text-center relative dark:border-slate-700/60"
                >
                ...
                <div class="lg:w-[600px] w-full">
                    ...
                    >
                        <ul class="uk-slideshow-items">
                            ...
                            <li class="w-full">
                                <div
                                    class="flex justify-center items-center flex-col gap-4 h-full"
                                ...
                                >
                                    ...
                                    >
                                        <h3
                                            class="text-black font-semibold text-xl dark:text-white"
                                        >
                                            Sell Premium Photes
                                        </h3>
                                    </div>
                                    ...
                                    >
                                        <p class="text-sm text-center max-w-sm">
                                            ...
                                            high-quality photos and share them
                                    ...
                                    >
                                        <button
                                            type="button"
                                            class="bg-primary text-white rounded-lg py-1.5 px-4 text-sm mt-2 dark:bg-slate-700"
                            ...
                            <li class="w-full">
                                <div>
                                    <div
                                        class="p-8 space-y-4 font-normal text-sm"
                                    >
                                        <div
                                        ...
                                        <div
                                            class="md:flex items-start gap-16 justify-between"
                                        >
                                            <label class="md:w-32">
                                                Description
                                            </label>
                            ...
                            <li class="w-full">
                                ...
                                >
                                    <div
                                        class="relative w-full h-[395px] border1 rounded-lg overflow-hidden bg-[url('../images/ad_pattern.html')] bg-repeat"
                                    >
                                        <label
                                            for="createProductUrl"
                            ...
                            <li class="w-full !relative">
                                <div class="lg:!h-[460px] overflow-y-auto">
                                    ...
                                    >
                                        <div class="p-6">
                                            <ul
                                                class="divide-y divide-gray-100 font-normal text-sm dark:divide-slate-700/60"
                                                uk-nav="multiple: true"
                                            >
                                                <li
                                                    class="uk-parent uk-open py-3"
                                                >
                                                    <a
                                                        href="#"
                                                ...
                                                >
                                                    ...
                                                    <ul
                                                        class="divide-y bg-secondery rounded-md dark:divide-slate-700/60"
                                                    >
                                                        <li>
                                                            <div
                                                                class="p-4 py-2"
                                                            >
                                                                <label
                                                                    class="switch flex justify-between items-center gap-4 cursor-pointer min-h-[30px]"
                                                                >
                                                                    <div>
                                                                        <h4>
                                                                            Generate
                                            ...
                                            <div
                                                class="flex justify-center p-6 pt-0 hidden"
                                            >
                                                <button
                                                    type="button"
                                                    class="button bg-blue-600 text-white px-10"
                                                >
                                                    Share
                                                </button>
                                            </div>
                            ...
                            <li class="w-full">
                                <div
                                    class="flex justify-center items-center flex-col gap-6 h-full"
                                    uk-scrollspy="target: > div; cls: uk-animation-scale-up; delay: 300;repeat:true"
                                >
                                    <div class="text-center">
                                        <ion-icon
                                            name="sparkles-sharp"
                                            class="text-5xl mb-6 text-blue-600 opacity-60 rotate-12"
                                        ></ion-icon>
                                        <h3
                                            class="text-black font-semibold text-xl dark:text-white"
                                        >
                                    ...
                                    <div class="font-medium text-sm">
                                        <div>
                                            ...
                                            >
                                                ...
                                                />
                                                <span class="ml-3">
                                                    I agree this product is mine
                                                    and i take resposibilty of
                        ...
                        <div
                            class="flex justify-center py-1.5 border-t relative dark:border-slate-700/60"
                        >
                            <button
                                type="button"
                                uk-slideshow-item="previous"
                                class="bg-secondery font-semibold py-1.5 px-3.5 rounded-full text-sm absolute left-4 bottom-3 leading-6 uk-animation-slide-left-small"
                            >
                                Previews
                            </button>

                            <ul
                                class="inline-flex flex-wrap justify-center my-5 uk-dotnav uk-slideshow-nav gap-2.5"
                            ></ul>

                            <button
                                type="button"
                                uk-slideshow-item="next"
                                class="bg-secondery font-semibold py-1.5 px-3.5 rounded-full text-sm absolute right-4 bottom-3 leading-6 uk-animation-slide-right-small"
                            >
                                Next
                            </button>
                        </div>
