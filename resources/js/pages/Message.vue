<template>
    ...
    >
        <div
            class="relative overflow-hidden border -m-2.5 dark:border-slate-700"
        >
            <div class="flex bg-white dark:bg-dark2">
                <!-- sidebar -->
                <div
                    class="md:w-[360px] relative border-r dark:border-slate-700"
                >
                    <div
                        id="side-chat"
                                ...
                                <div class="flex items-center gap-2.5">
                                    <button class="group">
                                        <ion-icon
                                            ...
                                            class="text-2xl flex group-aria-expanded:rotate-180"
                                        ></ion-icon>
                                    </button>
                                    <div
                ...
                <div class="flex-1">
                    ...
                    >
                        <div class="py-10 text-center text-sm lg:pt-8">
                            ...
                            <div class="mt-8">
                                <div
                                    class="md:text-xl text-base font-medium text-black dark:text-white"
                                >
                                    Monroe Parker
                                </div>
                                <div
                                    class="text-gray-500 text-sm dark:text-white/80"
                                >
                                    @Monroepark
                                </div>
                            </div>
                        ...
                        <div class="text-sm font-medium space-y-6">
                            ...
                            <div class="flex gap-3">
                                ...
                                />
                                <div
                                    class="px-4 py-2 rounded-[20px] max-w-sm bg-secondery"
                                >
                                    Hi, I’m John
                                </div>
                            </div>
                            ...
                            <div class="flex gap-3">
                                ...
                                <div
                                    class="px-4 py-2 rounded-[20px] max-w-sm bg-secondery"
                                >
                                    I’m selling a photo of a sunset. It’s a
                                    print on canvas, signed by the photographer.
                                    Do you like it? 😊
                                </div>
                            </div>
                            ...
                            <div class="flex gap-2 flex-row-reverse items-end">
                                ...
                                <div
                                    class="px-4 py-2 rounded-[20px] max-w-sm bg-gradient-to-tr from-sky-500 to-blue-500 text-white shadow"
                                >
                                    $200? Too steep. Can you lower the price a
                                    bit? 😕
                                </div>
                            </div>
                            ...
                            <div class="flex gap-3">
                                ...
                                <div
                                    class="px-4 py-2 rounded-[20px] max-w-sm bg-secondery"
                                >
                                    Well, I can’t go too low because I paid a
                                    lot. But I’m willing to negotiate. What’s
                                    your offer? 🤔
                                </div>
                            </div>
                            ...
                            <div class="flex gap-2 flex-row-reverse items-end">
                                ...
                                <div
                                    class="px-4 py-2 rounded-[20px] max-w-sm bg-gradient-to-tr from-sky-500 to-blue-500 text-white shadow"
                                >
                                    Too high. I Can’t . How about $160? Final
                                    offer. 😬
                                </div>
                            </div>
                            ...
                            <div class="flex gap-3">
                                ...
                                <div
                                    class="px-4 py-2 rounded-[20px] max-w-sm bg-secondery"
                                >
                                    Fine, fine. You’re hard to please. I’ll take
                                    $160, but only because I like you. 😍
                                </div>
                            </div>
                            ...
                            <div class="flex gap-2 flex-row-reverse items-end">
                                ...
                                <div
                                    class="px-4 py-2 rounded-[20px] max-w-sm bg-gradient-to-tr from-sky-500 to-blue-500 text-white shadow"
                                >
                                    Great, thank you. I appreciate it. I love
                                    this photo and can’t wait to hang it. 😩
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    >
                        ...
                        <button
                            type="button"
                            class="flex h-full dark:text-white"
                        >
                            <ion-icon
                                class="text-3xl flex -mt-3"
                                name="heart-outline"
                            ></ion-icon>
                        </button>
                    </div>
                ...
                <div
                    class="rightt w-full h-full absolute top-0 right-0 z-10 hidden transition-transform"
                >
                    <div
                    ...
                    >
                        <div
                            class="w-full h-1.5 bg-gradient-to-r to-purple-500 via-red-500 from-pink-500 -mt-px"
                        ></div>
                        ...
                        <div class="py-10 text-center text-sm pt-20">
                            ...
                            <div class="mt-8">
                                ...
                                <div
                                    class="text-gray-500 text-sm mt-1 dark:text-white/80"
                                >
                                    @Monroepark
                                </div>
                            </div>
                        ...
                        <ul class="text-base font-medium p-3">
                            <li>
                                ...
                                >
                                    ...
                                    Mute Notification
                                    <label
                                        class="switch cursor-pointer ml-auto"
                                    >
