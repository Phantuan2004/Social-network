<template>
    ...
    >
        <div
            class="flex 2xl:gap-12 max-lg:flex-col gap-10 2xl:max-w-[1220px] max-w-[1065px] mx-auto"
            id="js-oversized"
        >
            <div class="flex-1">
                <div class="box overflow-hidden">
                    <div class="relative h-80">
                        <img
                            src="/public/images/blog/img-5.png"
                            class="h-36 mb-4 w-full h-full object-cover"
                        />

                        <!-- optional -->
                        <div
                            class="p-6 w-full z-10 absolute bg-gradient-to-t bottom-0 from-black/60 hidden"
                        >
                            ...
                            <div
                                class="flex items-center gap-5 mt-4 !text-white"
                            >
                                <div
                                    class="w-6 h-6 flex-shrink-0 rounded-md relative"
                                >
                                    <img
                    ...
                    <div class="p-6">
                        ...
                        <div class="flex gap-3 text-sm mt-6">
                            ...
                            <div class="flex-1">
                                ...
                                <div
                                    class="text-gray-500 font-medium text-xs dark:text-white/80"
                                >
                                    2 hours ago
                                </div>
                            </div>
                        ...
                        <div
                            class="space-y-2 text-sm font-normal mt-6 leading-6 text-black dark:text-white"
                        >
                            <p>
                                Lorem ipsum dolor sit amet, consectetur
                                adipiscing elit, sed do eiusmod tempor veniam,
                            ...
                            <p>
                                ...
                                sit voluptatem accusantium inventore veritatis
                            ...
                            <p>
                                ...
                                sit voluptatem accusantium inventore veritatis
                                et quasi architecto beatae vitae dicta sunt
                                explicabo , consectetur adipiscing elit, sed do
